        ...
        {isOpen && (
          <div className="fixed left-0 top-0 z-10 flex h-screen w-screen items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="container relative flex flex-col gap-4 rounded-md bg-main-400 p-4">
              ...
              <h1>Edit Listing</h1>
              <form action="">
                <input type="text" id="start_time" name="start_time" defaultValue={formatDate(entry.start_time)} />
                <input type="text" id="end_time" name="end_time" defaultValue={formatDate(entry.end_time)} />
                <input type="text" id="duration" name="duration" defaultValue={formatDuration(entry.duration)} />
                <input type="text" id="category_name" name="category_name" defaultValue={entry.category_name} />
                <input
                  type="text"
                  id="description"
                  name="description"
                ...
                <input
                  ...
                  defaultValue={entry.meeting_link ?? ''}
                />
              </form>
            </div>
          </div>
